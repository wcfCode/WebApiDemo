...
namespace DependencyInjectionDemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.TryAddSingleton<IOrderService, OrderServiceEx>();//是对接口的尝试注册

            //services.TryAddEnumerable(ServiceDescriptor.Singleton<IOrderService, OrderServiceEx>());//是对实例的尝试注册
